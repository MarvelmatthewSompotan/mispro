...
const Registration = () => {
  ...
  const [filters, setFilters] = useState({ ECP: false, ES: false, MS: false, HS: false });
  ...
  return (
    <div className={styles.registrationPage}>
      ...
      <div className={styles.topBar}>
        <Button className={styles.newFormBtn} onClick={handleNewForm}>New Form</Button>
      </div>
      {/* Search Bar */}
      ...
      <div className={styles.filtersSection}>
        ...
        <div className={styles.filtersRow}>
          ...
          <select value={semester} onChange={e => setSemester(e.target.value)} className={styles.semesterSelect}>
            <option>Semester 1</option>
            <option>Semester 2</option>
          </select>
          {/* Ganti <a> dengan <button> agar aksesibel jika tidak ada href valid */}
          <button type="button" className={styles.seeAllForms}>See All Forms</button>
        </div>
      </div>
      {/* Results Info */}
